...
class App:
    def __init__(self, window, window_title, video_source1=0, video_source2=2):
        ...
        self.vid1 = tkCamera(self.camera_frame1, video_source1, enable_people_detection=False,enable_qr_detection=False)
        self.vid1.pack(expand=True, fill='both')  # Changed to pack

        self.vid2 = tkCamera(self.camera_frame2, video_source2, enable_people_detection=True,enable_qr_detection=True)
